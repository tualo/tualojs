Ext.define('Ext.tualo.form.field.MD5',  {
	        	...
	        	var wnd = Ext.create('Ext.tualo.Window',{
	        		...
	        		items: [
	        		    Ext.create('Ext.form.Panel',{
	        		    	...
	        		    	frame: true,
	        		    	items: [
	        		    	        first = Ext.create('Ext.form.field.Text',{
	        		    	        	inputType: 'password',
	        		    	        	fieldLabel: 'Passwort',
	        		    	        	listeners:{
	        		    	        		scope: this,
	        		    	        		change: function(t,n,o){
	        		    	        			var m = this.isSave(n);
	        		    	        			t.progress.updateProgress(m.number,m.text);
	        		    	        		}
	        		    	        	}
	        		    	        }),
	        		    	        
	        		    	        second = Ext.create('Ext.form.field.Text',{
	        		    	        	inputType: 'password',
	        		...
	        		buttons:[
	        		         ...
	        		         },
	        		         {
	        		        	 ...
	        		        	 handler: function(btn){
	        		        		 var wnd = btn.up().up();
	        		        		 if (wnd.first.getValue()==wnd.second.getValue()){
	        		        			 wnd.field.setValue(MD5(wnd.first.getValue()));
	        		        			 wnd.close();
	        		        		 }else{
	        		        			 Ext.MessageBox.alert("Fehler","Die beiden Eingaben stimmen nicht überein.");
	        		        		 }
	        		        	 }
	        		         }
	        		]
	...
	isSave: function(val){
		   // Über die DOM-Methode document.getElementById wird der Wert aus
			// dem Eingabefeld geholt
		...
		var msg = "";
		   ...
		   {    
		      ...
		      // Wenn das Passwort neben Buchstaben zusätzlich wenigstens eine
				// Zahl
		      ...
		      if (val.match(/\d{1,}/) && val.match(/[a-zA-ZäöüÄÖÜ]{1,}/) && val.match(/\W/)) 
		        ...
		        // Wenn das Passwort nur eine Zahl oder ein Sonderzeichen
				// enthält, ist es "sicher"?
		        else if (val.match(/\d{1,}/) && val.match(/[a-zA-ZäöüÄÖÜ]{1,}/) || val.match(/\W/) && val.match(/[a-zA-ZäöüÄÖÜ]{1,}/)) 
		        {   
				    call = 0.66;
				    msg="Sicher";
		        }
		        else // Hier enthält das Passwort weder Ziffern noch
						// Sonderzeichen und ist somit "unsicher".
		        {   
		        	call = 0.3;
		        	msg="Unsicher";
