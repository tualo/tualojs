 ...
 */
Ext.define('Tualo.grid.plugin.AutoRowExpander', {
    ...
    alias: 'plugin.tualo_rowexpander',
    ...
    bindView: function (view) {
        ...
        if (me.expandOnSelect) {
            listeners.select = me.onSelect;
        }
    ...
    onSelect: function (view, record, rowIdx, e) {
        this.toggleRow(rowIdx, record);
    },
